...
export default {
  ...
  data() {
    return {
         ...
         brand: "-1",
      secondaryFilters: [
        { label: "Max Amount", placeholder: "Enter Max Amount", value: "", type: "number", filter_mode:"A"},
        { label: "Min Amount", placeholder: "Enter Min Amount", value: "", type: "number", filter_mode:"B"},
        { label: "Full Name", placeholder: "Enter Full Name", value: "", type: "text", filter_mode:"C"},
      ],
      filters: {
        dateRange: "",
        datepick: false,
